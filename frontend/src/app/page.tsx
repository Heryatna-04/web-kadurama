...
interface NewsItem {
  ...
  slug?: string;
  title: string;
  category: "Pemerintahan" | "Bansos" | "Pembangunan" | "Kesehatan" | "Kegiatan" | "Ekonomi";
  date: string;
  author: string;
  summary: string;
  status: "Terbit" | "Draf";
...
const INITIAL_NEWS: NewsItem[] = [
  {
    ...
    summary: "Ini adalah ringkasan contoh berita 1 untuk pengujian tata letak portal resmi Desa Kadurama.",
    status: "Terbit",
  ...
  },
  {
    ...
    author: "Operator Desa",
    summary: "Ini adalah ringkasan contoh berita 2 untuk pengujian navigasi kategori dan halaman warta desa.",
    status: "Terbit",
  ...
  },
  {
    ...
    author: "Operator Desa",
    summary: "Ini adalah ringkasan contoh berita 3 untuk pengujian penyaringan kategori warta bidang kesehatan.",
    status: "Terbit",
  ...
  },
  {
    ...
    author: "Operator Desa",
    summary: "Ini adalah ringkasan contoh berita 4 untuk menguji tampilan kartu warta pada layar desktop dan seluler.",
    status: "Terbit",
    imageUrl: "/dusun-manis.jpg",
  },
  {
    ...
    author: "Operator Desa",
    summary: "Ini adalah ringkasan contoh berita 5 untuk menguji fungsi pencarian warta dan tagar terkait.",
    status: "Terbit",
    imageUrl: "/dusun-pahing.jpg",
  },
];
