...
export const PAMONG_LIST: PamongItem[] = [
  ...
  },
  {
    id: "PAMONG-003",
    name: "AHMAD DAHLAN",
    role: "Kepala Dusun I Manis",
    category: "Kewilayahan",
    dusun: "Manis",
    workArea: "Dusun Manis (RT 01 s.d. RT 08)",
    bio: "Penanggung jawab ketenteraman wilayah gerbang desa, koordinasi pelayanan warga di pusat pemerintahan, dan pengawasan fasilitas publik Dusun Manis.",
  ...
  },
  {
    id: "PAMONG-004",
    name: "ROHMAT HIDAYAT",
    role: "Kepala Dusun II Pahing",
    category: "Kewilayahan",
    dusun: "Pahing",
    workArea: "Dusun Pahing (RT 01 s.d. RT 07)",
    bio: "Penggerak sektor lumbung padi organik, pembina kelompok tani Gapoktan Sri Mukti, dan pengelola sarana olahraga terpadu Gelora Kadurama.",
  ...
  },
  {
    id: "PAMONG-005",
    name: "AGUS SETIAWAN",
    role: "Kepala Dusun III Wage",
    category: "Kewilayahan",
    dusun: "Wage",
    workArea: "Dusun Wage (RT 01 s.d. RT 06)",
    bio: "Pengawal kelestarian mata air purba Cikaduran, pengembang agrowisata ubi jalar lereng Ciremai, dan pendamping kelompok peternak sapi perah rakyat.",
