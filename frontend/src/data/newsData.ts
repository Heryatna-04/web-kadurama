...
export const NEWS_ARTICLES: NewsArticle[] = [
  {
    ...
    content: [
      ...
      "Dalam sambutannya, Kepala Desa Kadurama Suhendra, S.Sos menekankan bahwa arah kebijakan pembangunan desa tahun 2027 tetap menitikberatkan pada dua pilar pokok: penguatan infrastruktur konektivitas pertanian antardusun dan penanganan kerentanan sosial warga miskin ekstrem secara presisi.",
  ...
  },
  {
    ...
    author: "Aep Saepulloh",
    authorRole: "Kaur Pembangunan",
    readTime: "4 menit baca",
    ...
    content: [
      ...
      "Kepala Dusun Wage, Bpk. Agus Setiawan, menyampaikan rasa syukur masyarakat setempat atas realisasi drainase ini karena dapat melindungi pemukiman warga dari genangan air sekaligus mengalirkan buangan air ke saluran irigasi tersier persawahan.",
